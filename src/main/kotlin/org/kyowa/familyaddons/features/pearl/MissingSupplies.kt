...
object Prio {
    ...
    private val normalPrio: Map<Pre, Vec3d> = mapOf(
    ...
    private val newPrio: Map<Pre, Vec3d> = mapOf(
    ...
    /**
     * Returns the supply Vec3d to throw at given the player is currently in [spot],
     * or null if no supply is assigned (e.g. NONE or SQUARE with nothing missing).
     */
    fun getSupplyForSpot(spot: Pre): Vec3d? {
        if (spot == Pre.SQUARE) {
