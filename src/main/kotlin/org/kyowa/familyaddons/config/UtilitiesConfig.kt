...
class UtilitiesConfig {
    ...
    @Expose @JvmField
    @ConfigAccordionId(id = 80)
    @ConfigOption(name = "Freelook", desc = "Spin the camera around your character while your character keeps facing the way they were. Useful for checking your back without turning. Hold (or toggle) the keybind below.")
    @ConfigEditorBoolean
